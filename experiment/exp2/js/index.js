...
// In this experiment, we test on Whether islands.
// Another version of the experiment tested both at once,
// shuffling and selecting one at random per participant.
shuffled_conditions = ["WH", "SUBJ"]; //shuffle(["SUBJ","WH"]);
